...
/// Heap initialization for the kernel and useful functions for working with vmem
use x86_64::{PhysAddr, VirtAddr, registers::control::Cr3, structures::paging::{FrameAllocator, Mapper, OffsetPageTable, Page, PageTable, PageTableFlags, PhysFrame, Size4KiB, mapper::MapToError, page_table::FrameError}};
...
fn translate_addr_inner(addr: VirtAddr, table: PhysAddr, physical_memory_offset: VirtAddr) 
    ...
    for &index in &table_indexes {
        // convert frame into page table ref
...
pub const HEAP_START: u64 = 0xFFFF_C444_4444_0000;
